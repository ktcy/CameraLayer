(function() {
  ...
  CameraLayer = (function(_super) {
    ...
    CameraLayer.prototype.start = function() {
      return this._getSources((function(_this) {
        return function(sources) {
          var camera, newId, oldId, _ref;
          camera = _.find(sources, {
            kind: "video",
    ...
    CameraLayer.prototype._getSources = (function() {
      var MediaStreamTrack, getSources, getSourcesFallback, _ref;
      MediaStreamTrack = (_ref = window.MediaStreamTrack) != null ? _ref : {};
      getSources = MediaStreamTrack.getSources;
      getSourcesFallback = function() {};
      return (getSources != null ? getSources : getSourcesFallback).bind(MediaStreamTrack);
    })();

    CameraLayer.prototype._getUserMedia = (function() {
      var getUserMedia, getUserMediaFallback, _ref;
      getUserMedia = (_ref = navigator.getUserMedia) != null ? _ref : navigator.webkitGetUserMedia;
      getUserMediaFallback = function() {};
      return (getUserMedia != null ? getUserMedia : getUserMediaFallback).bind(navigator);
    })();
    ...
    CameraLayer.prototype._supportUserMedia = function() {
      var createObjectURL, getUserMedia, _ref, _ref1;
      getUserMedia = (_ref = navigator.getUserMedia) != null ? _ref : navigator.webkitGetUserMedia;
      createObjectURL = (_ref1 = window.URL) != null ? _ref1.createObjectURL : void 0;
